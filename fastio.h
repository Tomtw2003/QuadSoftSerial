...
/// write to a pin
#define		_WRITE_0(IO)			(DIO ##  IO ## _WPORT &= ~MASK(DIO ## IO ## _PIN) )
#define		_WRITE_1(IO)			(DIO ##  IO ## _WPORT |= MASK(DIO ## IO ## _PIN) )
...
#define		WRITE_0(IO)			_WRITE_0(IO)
#define		WRITE_1(IO)			_WRITE_1(IO)
#define		WRITE_LOW(IO)			_WRITE_0(IO)
#define		WRITE_HIGH(IO)			_WRITE_1(IO)
...
#define SCLK_HIGH() (PORTB |= _BV (5))
#define SCLK_LOW() (PORTB &= ~_BV (5))

#define MOSI_HIGH() (PORTB |= _BV (3))
#define MOSI_LOW()  (PORTB &= ~_BV (3))

#define SPI_pause()  (SPCR &= ~_BV(SPE))
#define SPI_resume() {SPCR |= _BV(MSTR);  SPCR |= _BV(SPE);}


#define digitalWrite_0_HIGH()  (PORTD |= _BV (0))
#define digitalWrite_1_HIGH()  (PORTD |= _BV (1))
#define digitalWrite_2_HIGH()  (PORTD |= _BV (2))
#define digitalWrite_3_HIGH()  (PORTD |= _BV (3))
#define digitalWrite_4_HIGH()  (PORTD |= _BV (4))
#define digitalWrite_5_HIGH()  (PORTD |= _BV (5))
#define digitalWrite_6_HIGH()  (PORTD |= _BV (6))
#define digitalWrite_7_HIGH()  (PORTD |= _BV (7))
#define digitalWrite_8_HIGH()  (PORTB |= _BV (0))
#define digitalWrite_9_HIGH()  (PORTB |= _BV (1))
#define digitalWrite_10_HIGH() (PORTB |= _BV (2))
#define digitalWrite_11_HIGH() (PORTB |= _BV (3))
#define digitalWrite_12_HIGH() (PORTB |= _BV (4))
#define digitalWrite_13_HIGH() (PORTB |= _BV (5))
#define digitalWrite_A0_HIGH() (PORTC |= _BV (0))
#define digitalWrite_A1_HIGH() (PORTC |= _BV (1))
#define digitalWrite_A2_HIGH() (PORTC |= _BV (2))
#define digitalWrite_A3_HIGH() (PORTC |= _BV (3))
#define digitalWrite_A4_HIGH() (PORTC |= _BV (4))
#define digitalWrite_A5_HIGH() (PORTC |= _BV (5))

#define digitalWrite_0_LOW()  (PORTD &= ~_BV (0))
#define digitalWrite_1_LOW()  (PORTD &= ~_BV (1))
#define digitalWrite_2_LOW()  (PORTD &= ~_BV (2))
#define digitalWrite_3_LOW()  (PORTD &= ~_BV (3))
#define digitalWrite_4_LOW()  (PORTD &= ~_BV (4))
#define digitalWrite_5_LOW()  (PORTD &= ~_BV (5))
#define digitalWrite_6_LOW()  (PORTD &= ~_BV (6))
#define digitalWrite_7_LOW()  (PORTD &= ~_BV (7))
#define digitalWrite_8_LOW()  (PORTB &= ~_BV (0))
#define digitalWrite_9_LOW()  (PORTB &= ~_BV (1))
#define digitalWrite_10_LOW() (PORTB &= ~_BV (2))
#define digitalWrite_11_LOW() (PORTB &= ~_BV (3))
#define digitalWrite_12_LOW() (PORTB &= ~_BV (4))
#define digitalWrite_13_LOW() (PORTB &= ~_BV (5))
#define digitalWrite_A0_LOW() (PORTC &= ~_BV (0))
#define digitalWrite_A1_LOW() (PORTC &= ~_BV (1))
#define digitalWrite_A2_LOW() (PORTC &= ~_BV (2))
#define digitalWrite_A3_LOW() (PORTC &= ~_BV (3))
#define digitalWrite_A4_LOW() (PORTC &= ~_BV (4))
#define digitalWrite_A5_LOW() (PORTC &= ~_BV (5))
